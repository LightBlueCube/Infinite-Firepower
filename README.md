...
当泰坦死亡且电池仓内有电池时 60%掉落黄电池 4%掉落绿电池 36%不掉落
...
军团智障核心开启期间，对非装甲单位造成的伤害 \* 0.1，对装甲单位造成的伤害 \* 1.5
...
[^7]:表现为帝王的火箭弹群，容量12发，可以在未充能完毕的情况下使用（只发射符合充能百分比数量的飞弹），冷却时间为 帝王火箭弹群冷却时间 \* 1.5
...
[^11]:涡旋盾至少需要100剩余的能量才可以开启，当武器击中涡旋盾时，增加能量，计算公式为 近距离对装甲单位伤害 / 2500 = 要增加的百分比 如果要增加的百分比 <= 10% 则用该计算公式: near_val / 1250 = 要增加的百分比
