...
[^17]:表现为帝王的能量汲取，冷却时间为20秒（12 -> 20），击中伤害为1200，按住不到1.2秒就松开时，发射一束能量汲取，击中敌方自己回盾2500，当按住超过1.2秒时，发射一个速度较慢的电球（速度为200），伤害为100，伤害敌方装甲单位可以回盾，每造成一次伤害自己恢复300的盾，如果盾满，则每造成一次伤害自己恢复100的血量
