...
const array<string> docs =    [ "前言\n因为Emma稳定发挥，broadcast chathook 还有logsystem都是被整寄了\n所以现版本几乎没有什么能发送大量文字的方法\n所以想了这个分页法，所以阅读体验会比较差，因为一次只能显示不几行\n任何更新都会同步更新文档，常来看看！",
								...
								"火焰核心对装甲单位伤害 4500 -> 3200  对非装甲单位伤害 300 -> 200",
								"----新的泰坦！----",
								...
								"主武器：NULL（空）",
								"核心：GroundSlam[注释10]",
								"[注释10]:DB大佬制作的核心，对非装甲单位伤害为500，对装甲单位伤害为4000，无衰减伤害范围 0-450  有衰减伤害范围 450-525  超过范围525外则无伤害\n启动后立刻恢复激素的冷却，后提供一个根据视角朝向的大小为1200速度 + 高度轴的一个大小为-750的速度，执行烈焰的拍地动作",
								...
								"右栏位：绊雷[注释22]",
								"[注释23]:表现为火箭弹群，发射一个黏性绊雷，落地后存在30秒，如果敌方单位靠近则立刻爆炸\n伤害为 对非装甲单位 1000 对装甲单位 1000，无衰减范围 0-140 衰减范围 140-320 范围超过320无伤害",
								"主武器：40cm机炮[注释24]",
